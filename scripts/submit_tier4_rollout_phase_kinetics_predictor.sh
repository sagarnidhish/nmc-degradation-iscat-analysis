...
#SBATCH --output=/scratch/<account>/<username>/Alek_Jiho/derived/logs/rollout_phase_pred_%j.out
#SBATCH --error=/scratch/<account>/<username>/Alek_Jiho/derived/logs/rollout_phase_pred_%j.err
