...
def main() -> None:
    ...
    source_balanced_pre_event_review_first = source_balanced_pre_event_review_top[0] if source_balanced_pre_event_review_top else {}
    ...
    report_lines = [
        ...
        f"- Pre-event review packet converts the source-invariant/front hypotheses into {first_summary(source_balanced_pre_event_review_packet, 'n_candidates', 0)} ranked ROI candidates with {first_summary(source_balanced_pre_event_review_packet, 'n_rendered_frame_strips', 0)} rendered frame strips and a contact sheet; top candidate is {source_balanced_pre_event_review_first.get('roi_id', 'NA')} ({source_balanced_pre_event_review_first.get('event_relative_bin', 'NA')}) with score {fmt(source_balanced_pre_event_review_first.get('pre_event_review_score'))}.",
    ...
    report_lines += [
        ...
        f"- Top review candidate: {source_balanced_pre_event_review_first.get('roi_id', 'NA')} cycle {fmt(source_balanced_pre_event_review_first.get('cycleNo'), 0)} {source_balanced_pre_event_review_first.get('event_relative_bin', 'NA')} score {fmt(source_balanced_pre_event_review_first.get('pre_event_review_score'))}, reason {source_balanced_pre_event_review_first.get('review_reason', 'NA')}, source-invariant clean probability {fmt(source_balanced_pre_event_review_first.get('si_clean_physics_prob'))}",
