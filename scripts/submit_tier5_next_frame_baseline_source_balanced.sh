...
#SBATCH --output=/scratch/<account>/<username>/Alek_Jiho/derived/logs/tier5_nf_sb_%j.out
#SBATCH --error=/scratch/<account>/<username>/Alek_Jiho/derived/logs/tier5_nf_sb_%j.err
