...
- Raw pre-event source-lattice coverage confirms this is a real data-design gap, not a sampler artifact: 5 raw sources have near-pre rows, 0 have near+far rows, and 4 separate sources can serve only as cross-source far-pre controls under source/acquisition matching.
...
- Pre-event echem/front coupling audit joins 128 ROI rows to 39 cycle-level echem descriptors; strongest echem link is shape_V_mean vs kymograph_temporal_energy rho 0.592, while the best source+echem residual event-bin row is clean_pre_1_8_vs_post_control front_radius_slope_px_per_norm_time at AUC 0.641, p=0.080.
- Pre-event echem-matched residual audit pairs near-pre rows on source/acquisition/echem context and tests source+echem residual outcomes; top row is near_vs_mid_pre same_source apparent_diffusion_q70_um2_per_norm_time with median near-control diff 0.930, p=9.990e-04; best near-vs-far residual row is front_radius2_slope_px2_per_norm_time p=0.009.
- Pre-event front-consensus audit combines residual outward-front, raw outward-front, quantile sign, and front-quality evidence across 128 ROI rows; unpaired event-bin separation remains weak (best near_vs_any_non_near front_quantile_positive_fraction AUC 0.599, p=0.072), but matched consensus is strong (near_vs_mid_pre same_source front_consensus_score median diff 4.946, p=9.990e-04). Top consensus-ranked ROI is source_balanced_cycle38_rank42_obj2_5_c2_x10_260623 from far_pre_event_17_32.
- Pre-event echem-matched far-control audit explicitly stress-tests the missing same-source near/far gap: source-class+echem/context matching forms 32 near-vs-far pairs from 3 far-control sources; best row is same_source_class_context_only front_radius2_slope_px2_per_norm_time median diff 15.954, sign-flip p=9.990e-04.
- Pre-event consensus review queue combines source-invariant review scores, radial fronts, source/echem residuals, and matched-control support into 128 ranked manual-QC candidates; 21 are matched-support front-QC candidates, led by source_balanced_cycle151_rank28_obj1_17_c2_x10_HighHighCOV_150723 at score 0.932.
- Pre-event consensus visual packet renders 24 frame strips and 24 radial kymographs for the consensus top candidates, with contact sheets for manual QC; top visual ROI is source_balanced_cycle151_rank28_obj1_17_c2_x10_HighHighCOV_150723.
- Pre-event visual QC modes score the 24 rendered candidates with front-trace plausibility and artifact-risk features; none reach accepted-front status, 8 are follow-up candidates, and the top automatic QC candidate is source_balanced_cycle152_rank29_obj1_17_c2_x10_HighHighCOV_150723 at score 0.590.
...
- Manual-QC visual packet renders 40 queue rows across 12 sources and action tiers {'context_control_concordant': 4, 'review_front_and_kinetics_first': 5, 'review_front_only_guardrail': 11, 'review_kinetic_only_guardrail': 8, 'review_strict_front_gate': 1, 'routine_or_low_concordance': 11}; contact sheet /scratch/<account>/<username>/Alek_Jiho/derived/source_balanced_pre_event_manual_qc_visual_packet/manual_qc_visual_contact_sheet.png.
- Blinded manual-QC workbook randomizes 40 rendered candidates with seed 20260522; reviewer-facing rows hide source/cycle/event/action metadata while the hidden key preserves action tiers {'context_control_concordant': 4, 'review_front_and_kinetics_first': 5, 'review_front_only_guardrail': 11, 'review_kinetic_only_guardrail': 8, 'review_strict_front_gate': 1, 'routine_or_low_concordance': 11}.
...
- Outputs: manifest /scratch/<account>/<username>/Alek_Jiho/derived/cycle78_front_identity_review_packet/cycle78_front_identity_review_manifest.csv; HTML /scratch/<account>/<username>/Alek_Jiho/derived/cycle78_front_identity_review_packet/cycle78_front_identity_review.html
...
- Review packet contact sheet: /scratch/<account>/<username>/Alek_Jiho/derived/source_balanced_pre_event_review_packet/pre_event_review_contact_sheet.png
...
- Source-lattice raw cycles/sources/HDF5 sources: 89 / 16 / 16
- Source-lattice near-source counts: {'near_sources_no_within_source_control': 0, 'sources_with_near': 5, 'sources_with_near_far': 0, 'sources_with_near_mid': 3, 'sources_with_near_post_or_control': 2}; candidate far-control sources: [{'cycle_max': 134, 'cycle_min': 131, 'far_pre_rows': 2, 'h5_available': True, 'source_class': 'HighCOV', 'source_stem': '15_c2_x5_HighCOV_120723'}, {'cycle_max': 145, 'cycle_min': 136, 'far_pre_rows': 4, 'h5_available': True, 'source_class': 'HighHighCOV', 'source_stem': '16_c2_x10_HighHighCOV_130723'}, {'cycle_max': 34, 'cycle_min': 26, 'far_pre_rows': 4, 'h5_available': True, 'source_class': 'nominal', 'source_stem': '4_c2_x10_240623'}, {'cycle_max': 44, 'cycle_min': 36, 'far_pre_rows': 4, 'h5_available': True, 'source_class': 'nominal', 'source_stem': '5_c2_x10_260623'}]
- Source-lattice design recommendation: Do not claim same-source near-vs-far evidence from current raw coverage: no source with near-pre rows also has far-pre rows.; Use same-source near-vs-mid and near-vs-post/control as local opportunistic checks where available.; Use cross-source far-pre controls only with explicit source/acquisition-class matching or source-residualization.
- Source-lattice guardrail: This is a coverage/design audit over the raw particle cycle/source index. It identifies feasible controls and missing same-source ladders; it does not add manual labels, validate particles/fronts, calibrate diffusion, or establish precursor causality.
...
- Echem/front coupling rows/cycles/sources/echem-features/targets: 128 / 64 / 14 / 39 / 20
- Top raw echem/front event-bin row: clean_pre_1_8_vs_post_control masked_minus_background_mean_slope n=32 vs 52, median diff 0.006, AUC 0.797, p=5.478e-06
- Top source+echem residual event-bin row: clean_pre_1_8_vs_post_control front_radius_slope_px_per_norm_time n=23 vs 31, residual median diff 0.210, AUC 0.641, p=0.080
- Top echem/optical correlation: shape_V_mean vs kymograph_temporal_energy n=122, rho 0.592, p=7.049e-13; strongest residual fit is front_gradient_strength_median variance explained 0.943
- Echem/front coupling guardrail: Cycle-level echem descriptors are joined to ROI-level automatic front/kymograph proxies, so rows are clustered by cycle and source. Residualization is an explanatory stress test, not causal evidence, calibrated diffusion, validated phase-boundary tracking, or a deployable warning model.
- Echem-matched residual rows/cycles/sources/match-features/outcomes: 128 / 64 / 14 / 54 / 51
- Echem-matched residual pair counts: {'near_vs_any_non_near|same_source': 32, 'near_vs_any_non_near|source_class_penalized_echem_context': 32, 'near_vs_any_non_near|source_penalized_echem_context': 32, 'near_vs_far_pre|source_class_penalized_echem_context': 32, 'near_vs_far_pre|source_penalized_echem_context': 32, 'near_vs_mid_pre|same_source': 20, 'near_vs_mid_pre|source_class_penalized_echem_context': 32, 'near_vs_mid_pre|source_penalized_echem_context': 32, 'near_vs_post_control|same_source': 12, 'near_vs_post_control|source_class_penalized_echem_context': 32, 'near_vs_post_control|source_penalized_echem_context': 32}; same-source fractions: {'near_vs_any_non_near|same_source': 1.0, 'near_vs_any_non_near|source_class_penalized_echem_context': 0.125, 'near_vs_any_non_near|source_penalized_echem_context': 0.59375, 'near_vs_far_pre|source_class_penalized_echem_context': 0.0, 'near_vs_far_pre|source_penalized_echem_context': 0.0, 'near_vs_mid_pre|same_source': 1.0, 'near_vs_mid_pre|source_class_penalized_echem_context': 0.15625, 'near_vs_mid_pre|source_penalized_echem_context': 0.3125, 'near_vs_post_control|same_source': 1.0, 'near_vs_post_control|source_class_penalized_echem_context': 0.0, 'near_vs_post_control|source_penalized_echem_context': 0.3125}
- Top echem-matched residual row: near_vs_mid_pre same_source apparent_diffusion_q70_um2_per_norm_time n=14, median near-control diff 0.930, sign-flip p=9.990e-04
- Echem-matched residual guardrail: This audit pairs automatic ROI rows on observed source, acquisition, baseline, and cycle-level echem descriptors, then tests automatic source+echem residual front/kymograph proxies. Matching reuses controls and cannot resolve unobserved acquisition effects, particle identity, manual front validity, calibrated diffusion, phase-boundary mechanism, or degradation causality.
- Front-consensus rows/cycles/sources/matched-pairs/features: 128 / 64 / 14 / 320 / 8
- Top front-consensus event row: near_vs_any_non_near front_quantile_positive_fraction n=32 vs 96, median diff 0.333, AUC 0.599, p=0.072
- Top front-consensus matched row: near_vs_mid_pre same_source front_consensus_score n=20, median near-control diff 4.946, sign-flip p=9.990e-04
- Front-consensus guardrail: The consensus score combines automatic radial-front, kymograph, and source+echem residual proxies. It tests internal coherence and prioritizes manual QC, but it is still not calibrated diffusion, validated phase-boundary tracking, particle-identity proof, causal degradation evidence, or a deployable warning model.
- Echem-matched far-control rows/cycles/sources/permutations: 128 / 64 / 14 / 1000
- Echem-matched far-control pair counts: {'global_echem_context': 32, 'same_source_class_context_only': 32, 'same_source_class_echem_context': 32}; control source counts: {'global_echem_context': 4, 'same_source_class_context_only': 3, 'same_source_class_echem_context': 3}
- Top echem-matched far-control row: same_source_class_context_only front_radius2_slope_px2_per_norm_time n=19, median near-far diff 15.954, positive fraction 0.842, sign-flip p=9.990e-04
- Source-class+echem front-slope row: front_radius_slope_px_per_norm_time n=20, median near-far diff 0.675, p=0.004
- Echem-matched far-control guardrail: This is a cross-source far-control stress test because no same-source near-vs-far lattice exists. Source-class and echem/context matching reduce obvious confounding but cannot prove particle identity, causality, calibrated diffusion, or validated phase-boundary tracking.
- Consensus review queue candidates/cycles/sources: 128 / 64 / 14; priority tiers: {'matched_support_front_qc': 21, 'routine_review': 107}
- Top consensus review candidate: rank 1 source_balanced_cycle151_rank28_obj1_17_c2_x10_HighHighCOV_150723 near_pre_event_1_8 score 0.932, matched support 56, tier matched_support_front_qc
- Consensus review queue guardrail: This is a manual-QC prioritization queue built from automatic proxy evidence. It assigns no labels and does not validate particle identity, front masks, calibrated diffusion, phase-boundary tracking, degradation causality, or deployable warnings.
- Consensus visual packet queue/rendered/sources: 128 / 24 / 8; contact sheet: /scratch/<account>/<username>/Alek_Jiho/derived/source_balanced_pre_event_consensus_visual_packet/consensus_visual_contact_sheet.png
- Top consensus visual candidate: rank 1 source_balanced_cycle151_rank28_obj1_17_c2_x10_HighHighCOV_150723 near_pre_event_1_8 score 0.932, matched support 56
- Consensus visual packet guardrail: This packet renders automatic crop/front visualizations for manual inspection. It does not assign labels, validate particle identity, validate front masks, calibrate diffusion, prove phase-boundary motion, or establish causality.
- Visual sanity audit scored 24 rendered candidates: flags {'reviewable_auto': 9, 'uncertain_auto': 15}, median score 0.579; top reviewable candidate is rank 10 source_balanced_cycle78_rank61_obj2_9_c2_x10_010723 sanity 0.799.
- Visual sanity guardrail: Visual sanity metrics are automatic crop/front quality proxies. They can prioritize manual QC and flag artifact risk, but they are not manual labels, particle-identity validation, phase-boundary validation, calibrated diffusion, or degradation causality evidence.
- Visual QC modes scored/rendered: 24 / 24; tiers {'front_plausible_followup': 8, 'routine_or_low_front_plausibility': 16}; mode counts {'low front-plausibility context': 23, 'moderate front-like followup': 1}
- Top visual QC mode candidate: rank 2 source_balanced_cycle152_rank29_obj1_17_c2_x10_HighHighCOV_150723 tier front_plausible_followup score 0.590, front score 0.262, artifact risk 0.050
- Visual QC modes guardrail: Automatic visual/front plausibility scores and clusters are review priorities only. They do not validate particle identity, front masks, manual QC, calibrated diffusion, phase-boundary motion, or causality.
- Phase-kinetics rows/sources/features: 128 / 14 / 56; event bins {'far_pre_event_17_32': 22, 'mid_pre_event_9_16': 22, 'near_pre_event_1_8': 32, 'no_near_event_control': 12, 'post_event_1_16': 40}
- Top phase-kinetics event row: near_vs_any_non_near raw masked_minus_bg_slope n=128, median diff 0.004, AUC 0.816, p=8.993e-08, source eta2 0.504
- Top phase-kinetics matched row: global_echem_context near-vs-far_pre_event_17_32 masked_mean_total_variation n=32, median diff 0.008, positive fraction 0.688, p=4.998e-04
- Phase-kinetics guardrail: Source-balanced pre-event phase kinetics are automatic optical phase-fraction proxies inside stable particle masks with prior-mask fallback. Logistic/Avrami values are descriptive timing summaries, not calibrated reaction constants, manual phase labels, validated particle identities, or diffusion coefficients.
- Front/kinetic concordance rows/sources/tier counts: 128 / 14 / {'front_kinetic_concordant': 4, 'front_only_guardrail': 13, 'kinetic_only_guardrail': 7, 'near_pre_front_kinetic_review': 4, 'routine_or_low_concordance': 99, 'strict_gate_manual_front_review': 1}
- Top front/kinetic concordance candidate: source_balanced_cycle154_rank30_obj2_17_c2_x10_HighHighCOV_150723 near_pre_event_1_8 score 1.669, kinetic 2.030, front 1.585, tier near_pre_front_kinetic_review
- Best front/kinetic concordance event row: near_vs_any_non_near raw kinetic_evidence_score AUC 0.770, p=5.005e-06
- Front/kinetic concordance guardrail: Front/kinetic concordance is an automatic review-prioritization score joining optical phase kinetics, front proxies, visual QC, and strict gates. It does not assign manual labels, validate phase-boundary motion, calibrate diffusion, or prove degradation causality.
- Front/kinetic null rows/features/permutations/bootstrap: 128 / 9 / 50 / 0
...
- Manual-QC visual packet rendered/action-tiers/event-bins: 40 / {'context_control_concordant': 4, 'review_front_and_kinetics_first': 5, 'review_front_only_guardrail': 11, 'review_kinetic_only_guardrail': 8, 'review_strict_front_gate': 1, 'routine_or_low_concordance': 11} / {'far_pre_event_17_32': 4, 'mid_pre_event_9_16': 4, 'near_pre_event_1_8': 23, 'no_near_event_control': 3, 'post_event_1_16': 6}; contact sheet: /scratch/<account>/<username>/Alek_Jiho/derived/source_balanced_pre_event_manual_qc_visual_packet/manual_qc_visual_contact_sheet.png
- Top manual-QC visual candidate: rank 1 source_balanced_cycle80_rank62_obj2_9_c2_x10_010723 action review_strict_front_gate status ok
- Manual-QC visual guardrail: This packet renders automatic particle-crop visualizations for manual inspection. It does not assign labels, validate particle identity, validate front masks, calibrate diffusion, prove phase-boundary motion, or establish causality.
- Blinded manual-QC workbook rows/sources/action tiers: 40 / 12 / {'context_control_concordant': 4, 'review_front_and_kinetics_first': 5, 'review_front_only_guardrail': 11, 'review_kinetic_only_guardrail': 8, 'review_strict_front_gate': 1, 'routine_or_low_concordance': 11}; event bins {'far_pre_event_17_32': 4, 'mid_pre_event_9_16': 4, 'near_pre_event_1_8': 23, 'no_near_event_control': 3, 'post_event_1_16': 6}
- Blinded manual-QC workbook guardrail: This workbook randomizes and blinds manual review but does not assign labels. Do not open/use the hidden key until reviewer decisions are frozen; diffusion claims remain blocked unless manual labels support particle identity, front mask quality, and front-motion interpretability.
...
- Multimodal predictor guardrail: Leave-source multimodal pre-event models use automatic ROI crops, weak event-relative labels, and analysis-time source-confound transforms. They test whether masked phase kinetics add source-heldout signal to echem/front/QC features; they are not deployable warnings, manual labels, causal mechanisms, calibrated phase-boundaries, or diffusion coefficients.
- Strict QC-gated front audit candidates/manual-review/diffusion-claim: 24 / 1 / 0; gate pass counts {'automatic_diffusion_claim_gate': 0, 'centroid_stability_gate': 20, 'front_direction_agreement_gate': 11, 'front_trace_fit_gate': 4, 'manual_front_review_gate': 1, 'stable_mask_gate': 24, 'visual_mode_gate': 6, 'visual_sanity_gate': 9}
- Top strict QC-gated candidate: rank 8 source_balanced_cycle80_rank62_obj2_9_c2_x10_010723 near_pre_event_1_8 score 0.600, sanity 0.761, visual QC 0.506, front r2 0.279, manual gate True, diffusion gate False
- Strict QC-gated front guardrail: Strict QC gates are automatic review-prioritization gates. They do not create manual labels, validate particle identity or front masks, calibrate diffusion, prove phase-boundary motion, or establish causality. Rows failing the diffusion gate must not be used for material diffusion coefficient claims.
