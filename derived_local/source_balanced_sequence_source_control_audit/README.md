...
- future_any_drop_within_16cycles temporal_energy_late_minus_early (within_source_z): AUC 0.591, source p 0.004, AP 0.570
- future_any_drop_within_16cycles temporal_energy_late_minus_early (within_source_rank): AUC 0.573, source p 0.004, AP 0.551
- future_any_drop_within_16cycles temporal_energy_late_minus_early (raw): AUC 0.561, source p 0.004, AP 0.548
- future_any_drop_within_16cycles roi_norm_mean_positive_step_fraction (raw): AUC 0.602, source p 0.012, AP 0.603
- future_any_drop_within_8cycles stage_drift_xy_recomputed (within_source_rank): AUC 0.543, source p 0.028, AP 0.322
- future_any_drop_within_16cycles stage_drift_xy_recomputed (within_source_z): AUC 0.535, source p 0.050, AP 0.565
- future_any_drop_within_16cycles roi_norm_mean_positive_step_fraction (source_residual): AUC 0.568, source p 0.056, AP 0.619
